  ...
  return (
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <button
          type="button"
          className="bg-gradient-to-br from-orange-200 to-orange-500 w-full md:w-auto px-4 py-2 hover:text-white font-medium  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
        >
          Order Now
        </button>
      </div>
      ...
      <div className="py-2 flex-1 flex items-center relative">
        ...
        <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center py-4 gap-4 xl:px-32 flex-wrap">
          {heroData &&
            heroData.map((n) => (
              <div
                key={n.id}
